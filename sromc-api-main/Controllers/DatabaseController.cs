...
namespace SROMCapi.Controllers
{
    public class DatabaseController
    {
        ...
        /// 
        /// </summary>
        public static string ConnectionString = "Data Source=sql.bsite.net\\MSSQL2016;Initial Catalog=corvustr_;User ID=corvustr_;Password=hektor123;Connection Timeout=15";
